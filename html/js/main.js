...
var time = d.getHours();
if (time < 24) {
    document.getElementById("title").innerHTML = "一个导航 | 晚上好🌃";
}
if (time < 18) {
    document.getElementById("title").innerHTML = "一个导航 | 下午好🍵";
}
if (time < 12) {
    document.getElementById("title").innerHTML = "一个导航 | 早啊🌞";
}
if (time < 5) {
    document.getElementById("title").innerHTML = "一个导航 | 早点睡哦😪";
}
//title问候语结束
